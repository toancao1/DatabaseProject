...
<body>
	...
	if (isset($_SESSION["session_flag"])) {
		if ($_SESSION["session_flag"] == "valid") {
			...
			echo "<form action = \"search_record_orders_output.php\" method = \"POST\">
					Choose an attribute to search by<br>
					<input type=\"radio\" name=\"attribute\" value=\"OrderID\" checked> ID<br>
					<input type=\"radio\" name=\"attribute\" value=\"DateOfOrder\" >Date of Order<br>
