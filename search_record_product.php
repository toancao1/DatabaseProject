...
<body>
	...
	if (isset($_SESSION["session_flag"])) {
		if ($_SESSION["session_flag"] == "valid") {
			...
			echo "<form action = \"search_record_product_output.php\" method = \"POST\">
					Choose an attribute to search by<br>
					<input type=\"radio\" name=\"attribute\" value=\"ProductID\" checked> ID<br>
					<input type=\"radio\" name=\"attribute\" value=\"ProductName\" >Product Name<br>
