...
<body>
	...
	if (isset($_SESSION["session_flag"])) {
		if ($_SESSION["session_flag"] == "valid") {
			echo "<form action = \"update_record_registration_output.php\" method = \"POST\">
						Enter the ID of the record to update.<br/>
			...
			echo "<a href=\"login.php\"> Click here </a> to go to main menu.";
		} else {
